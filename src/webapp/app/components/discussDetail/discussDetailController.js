define(['byApp', 'byUtil', 'discussLikeController', 'discussDetailLeftController', 'discussReplyController', 'shareController', 'urlFactory'],
    function (byApp, byUtil, discussLikeController, discussDetailLeftController, discussReplyController, shareController, urlFactory) {
        function DiscussDetailController($scope, $rootScope, $routeParams, $location, DiscussDetail, $sce, broadCastData, $timeout, ErrorService, urlFactoryFilter) {
        ...
        DiscussDetailController.$inject = ['$scope', '$rootScope', '$routeParams', '$location', 'DiscussDetail', '$sce', 'broadCastData', '$timeout', 'ErrorService', 'UrlFactoryFilter'];
